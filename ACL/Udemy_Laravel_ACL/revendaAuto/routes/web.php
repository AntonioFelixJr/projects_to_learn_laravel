...
Route::group(['middleware' => 'auth',  'prefix' => 'admin'], function(){
  ...
  Route::post('usuarios/papel/{papel_id}', 'Admin\UsuarioController@papelStore')
    ->name('usuarios.papel.store');

  Route::delete('usuarios/papel/{usuario_id}/{papel_id}', 'Admin\UsuarioController@papelDestroy')
    ->name('usuarios.papel.destroy');


  Route::get('papeis/permissao/{id}', 'Admin\PapelController@permissoes')
    ->name('papeis.permissao');

  Route::post('papeis/permissao/{permissao}', 'Admin\PapelController@permissoesStore')
    ->name('papeis.permissao.store');

  Route::delete('papeis/permissao/{papel}/{permissao}', 'Admin\PapelController@permissoesDestroy')
